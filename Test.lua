...
function Not()
    ...
    Text = "à¸„à¸¸à¸“à¸¥à¸·à¸¡à¹€à¸¥à¸·à¸­à¸à¸­à¸²à¸§à¸¸à¸˜"; -- what the text says (ofc)
...
function Fot()
    ...
    Text = "à¸„à¸¸à¸“à¸¥à¸·à¸¡à¹€à¸¥à¸·à¸­à¸à¸œà¸¥à¸›à¸µà¸¨à¸²à¸ˆ"; -- what the text says (ofc)
...
function Sec()
    ...
    Text = "à¸à¹‡à¸­à¸›à¸›à¸µà¹‰à¹‚à¸„à¹‰à¸”à¸ªà¸³à¹€à¸£à¹‡à¸ˆ"; -- what the text says (ofc)
...
function Wea()
    ...
    Text = "à¹€à¸¥à¸·à¸­à¸à¸­à¸²à¸§à¸¸à¸˜ - à¸ªà¸³à¹€à¸£à¹‡à¸ˆ"; -- what the text says (ofc)
...
function Fse()
    ...
    Text = "à¹€à¸¥à¸·à¸­à¸à¸œà¸¥ - à¸ªà¸³à¹€à¸£à¹‡à¸ˆ"; -- what the text says (ofc)
...
function Next()
    ...
    Text = "à¸¡à¸²à¹€à¸£à¹‡à¸§à¹†à¸™à¸µà¹‰à¹à¸™à¹ˆà¸™à¸­à¸™"; -- what the text says (ofc)
...
----------------------------------------- Gui Go
    ...
    Title = "Winnable Hub"; -- the title (ofc)

    Text = "Winnable Hub"; -- what the text says (ofc)
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-472704.938, 64530268, -972040.25, -0.758185327, -0.621569872, -0.19699204, -1.37435279e-07, 0.30211705, -0.953270853, 0.652039111, -0.722755909, -0.229060814)
end)
